...
public class QueryTest {
    ...
    @Test public void applicationQuery() {
        QueryType type = GstQueryAPI.INSTANCE.gst_query_type_register("application_test", "An application query");
    ...
    @Test public void customQueryType() {
        QueryType qt = GstQueryAPI.INSTANCE.gst_query_type_register("test", "A test query type");
    ...
    @Test public void makeWriteable() {
        ...
        GstMiniObjectAPI.INSTANCE.gst_mini_object_ref(query);
