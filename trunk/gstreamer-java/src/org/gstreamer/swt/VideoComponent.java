        ...
        this.addPaintListener(new PaintListener() {
            ...
            public void paintControl(PaintEvent event) {
                ...
                if (currentImage != null) {
                    ...
                    ImageData imgdata = new ImageData(currentImage.getWidth(),
                            currentImage.getHeight(), 24, new PaletteData(
                    ...
                    if ((currentImage.getWidth() != cSize.x) || (currentImage.getHeight() != cSize.y)) {
                        ...
                        if (keepAspect) {
                            if (((float) currentImage.getWidth() / (float) cSize.x) > ((float) currentImage.getHeight() / (float) cSize.y)) {
                    ...
                    Image image = new Image(parent.getDisplay(), cSize.x,
                            cSize.y);
                    event.gc.drawImage(image, 0, 0);
                    event.gc.drawText("SWT canvas created", 10, 10);
                    image.dispose();
                }
            }
        });
